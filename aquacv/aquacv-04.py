...
while(cap.isOpened()):                    # play the video by reading frame by frame
    ...
    if ret == True:
        ...
        frame = rescaleFrame(videocap, 0.55)
        ...
        coverlay = edge.copy()
        cv2.rectangle(coverlay, (200, 10), (400, 80), (200, 0, 0, 0.5), -1)
        alpha = 0.4

        # alphagrey = cv2.addWeighted(coverlay, alpha, gray, 1 - alpha, 0)
        # cv2.imshow("XXX", alphagrey)
