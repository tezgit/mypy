...
class tezgrafobj:
    ...
    def recolor(self):
        ...
        if (rr == 0):
            ...
            self.rr = (random.randint(1, 47)) * cFactor[0]
            self.gg = (random.randint(1, 47)) * cFactor[1]
            self.bb = (random.randint(1, 47)) * cFactor[2]

    def tmove(self):

        self.LFO += random.random() + 0.1
        ...
        mycolor = (self.rr, self.gg, self.bb, abs(
            self.alf * math.cos(self.LFO)))
